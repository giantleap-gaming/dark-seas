...
export interface LastActionComponentInterface extends utils.Interface {
  contractName: "LastActionComponent";
  functions: {
...
export interface LastActionComponent extends BaseContract {
  contractName: "LastActionComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LastActionComponentInterface;
