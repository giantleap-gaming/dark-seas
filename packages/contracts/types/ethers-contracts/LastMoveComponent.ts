...
export interface LastMoveComponentInterface extends utils.Interface {
  contractName: "LastMoveComponent";
  functions: {
...
export interface LastMoveComponent extends BaseContract {
  contractName: "LastMoveComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LastMoveComponentInterface;
