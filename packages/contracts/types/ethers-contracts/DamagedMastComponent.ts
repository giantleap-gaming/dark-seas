...
export interface DamagedMastComponentInterface extends utils.Interface {
  contractName: "DamagedMastComponent";
  functions: {
...
export interface DamagedMastComponent extends BaseContract {
  contractName: "DamagedMastComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DamagedMastComponentInterface;
