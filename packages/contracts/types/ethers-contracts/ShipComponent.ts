...
export interface ShipComponentInterface extends utils.Interface {
  contractName: "ShipComponent";
  functions: {
...
export interface ShipComponent extends BaseContract {
  contractName: "ShipComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShipComponentInterface;
