...
import type { OwnedByComponent, OwnedByComponentInterface } from "../OwnedByComponent";
...
export class OwnedByComponent__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): OwnedByComponent {
