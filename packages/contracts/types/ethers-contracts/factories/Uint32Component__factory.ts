...
import type { Uint32Component, Uint32ComponentInterface } from "../Uint32Component";
...
export class Uint32Component__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): Uint32Component {
