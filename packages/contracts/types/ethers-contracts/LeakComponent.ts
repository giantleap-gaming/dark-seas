...
export interface LeakComponentInterface extends utils.Interface {
  contractName: "LeakComponent";
  functions: {
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [boolean]): string;
...
export interface LeakComponent extends BaseContract {
  contractName: "LeakComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LeakComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue(bool)"(value: boolean, overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  callStatic: {
    ...
    "set(uint256)"(entity: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue(bool)"(value: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
