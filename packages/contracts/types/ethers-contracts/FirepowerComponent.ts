...
export interface FirepowerComponentInterface extends utils.Interface {
  contractName: "FirepowerComponent";
  functions: {
...
export interface FirepowerComponent extends BaseContract {
  contractName: "FirepowerComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FirepowerComponentInterface;
