...
export interface LengthComponentInterface extends utils.Interface {
  contractName: "LengthComponent";
  functions: {
...
export interface LengthComponent extends BaseContract {
  contractName: "LengthComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LengthComponentInterface;
