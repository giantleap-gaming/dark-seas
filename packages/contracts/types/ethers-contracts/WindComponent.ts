...
export type WindStruct = { speed: BigNumberish; direction: BigNumberish };

export type WindStructOutput = [number, number] & {
  speed: number;
  direction: number;
};

export interface WindComponentInterface extends utils.Interface {
  contractName: "WindComponent";
  functions: {
...
export interface WindComponent extends BaseContract {
  contractName: "WindComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WindComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint32,uint32))"(wind: WindStruct, overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[WindStructOutput]>;
  ...
  callStatic: {
    ...
    "set(uint256,(uint32,uint32))"(entity: BigNumberish, wind: WindStruct, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue((uint32,uint32))"(wind: WindStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
