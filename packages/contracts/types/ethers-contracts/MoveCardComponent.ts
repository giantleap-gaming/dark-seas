...
export type MoveCardStructOutput = [number, number, number] & {
  distance: number;
  direction: number;
  rotation: number;
};
...
export interface MoveCardComponentInterface extends utils.Interface {
  contractName: "MoveCardComponent";
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue((uint32,uint32,uint32))": FunctionFragment;
    ...
    "set(uint256,(uint32,uint32,uint32))": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [MoveCardStruct]): string;
  ...
  encodeFunctionData(functionFragment: "set", values: [BigNumberish, MoveCardStruct]): string;
...
export interface MoveCardComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint32,uint32,uint32))"(
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[MoveCardStructOutput]>;
    ...
    "set(uint256,(uint32,uint32,uint32))"(
      entity: BigNumberish,
      moveCard: MoveCardStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
