...
export type GameConfigStruct = {
  ...
  commitPhaseLength: BigNumberish;
  revealPhaseLength: BigNumberish;
  actionPhaseLength: BigNumberish;
  worldRadius: BigNumberish;
};

export type GameConfigStructOutput = [BigNumber, number, number, number, number] & {
  startTime: BigNumber;
...
export interface GameConfigComponentInterface extends utils.Interface {
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint32,uint32,uint32,uint32))": FunctionFragment;
    ...
    "set(uint256,(uint256,uint32,uint32,uint32,uint32))": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [GameConfigStruct]): string;
  ...
  encodeFunctionData(functionFragment: "set", values: [BigNumberish, GameConfigStruct]): string;
...
export interface GameConfigComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint32,uint32,uint32,uint32))"(
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[GameConfigStructOutput]>;
    ...
    "set(uint256,(uint256,uint32,uint32,uint32,uint32))"(
      entity: BigNumberish,
      config: GameConfigStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
