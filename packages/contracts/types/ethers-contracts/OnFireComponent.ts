...
export interface OnFireComponentInterface extends utils.Interface {
  contractName: "OnFireComponent";
  functions: {
...
export interface OnFireComponent extends BaseContract {
  contractName: "OnFireComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnFireComponentInterface;
