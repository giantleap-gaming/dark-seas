...
export interface RangeComponentInterface extends utils.Interface {
  contractName: "RangeComponent";
  functions: {
...
export interface RangeComponent extends BaseContract {
  contractName: "RangeComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RangeComponentInterface;
