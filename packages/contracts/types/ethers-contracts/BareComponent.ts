...
export interface BareComponent extends BaseContract {
  ...
  functions: {
    ...
    getEntitiesWithValue(arg0: BytesLike, overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  estimateGas: {
    ...
    registerIndexer(arg0: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getEntitiesWithValue(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
