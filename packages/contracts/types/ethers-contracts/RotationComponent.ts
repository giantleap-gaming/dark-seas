...
export interface RotationComponentInterface extends utils.Interface {
  contractName: "RotationComponent";
  functions: {
...
export interface RotationComponent extends BaseContract {
  contractName: "RotationComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RotationComponentInterface;
