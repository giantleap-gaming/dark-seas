...
export interface StringComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue(string)"(value: string, overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  callStatic: {
    ...
    "set(uint256,string)"(entity: BigNumberish, value: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue(string)"(value: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
