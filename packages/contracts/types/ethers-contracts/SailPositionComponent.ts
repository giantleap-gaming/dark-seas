...
export interface SailPositionComponentInterface extends utils.Interface {
  contractName: "SailPositionComponent";
  functions: {
...
export interface SailPositionComponent extends BaseContract {
  contractName: "SailPositionComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SailPositionComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue(uint32)"(value: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  callStatic: {
    ...
    "set(uint256,uint32)"(entity: BigNumberish, value: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue(uint32)"(value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
