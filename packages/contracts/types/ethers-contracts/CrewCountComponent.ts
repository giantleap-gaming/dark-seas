...
export interface CrewCountComponentInterface extends utils.Interface {
  contractName: "CrewCountComponent";
  functions: {
...
export interface CrewCountComponent extends BaseContract {
  contractName: "CrewCountComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrewCountComponentInterface;
